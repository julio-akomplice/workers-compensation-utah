...
export const LandingPageWhyUsSectionBlock: React.FC<Props> = ({
  ...
  return (
    <section className="relative w-full overflow-hidden py-25 tablet:py-30">
      ...
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <div className={`absolute inset-0 ${mobileBackgroundImage ? 'hidden tablet:block' : ''}`}>
      ...
      <div className="container relative z-10 mx-auto px-5 tablet:px-8 desktop-sm:px-4">
        ...
        {items && items.length > 0 && (
          <div className="mx-auto grid max-w-304 grid-cols-1 gap-x-8 gap-y-10 tablet:grid-cols-3 tablet:gap-y-12.5">
