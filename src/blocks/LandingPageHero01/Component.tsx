...
export const LandingPageHero01Block: React.FC<Props> = ({
  ...
  return (
    <section className="relative isolate overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 -z-10 hidden desktop-sm:block bg-linear-to-r from-[#00070f]/80 to-[#00070f]/0 to-[41.78%]" />

      <div className="container mx-auto px-5 tablet:px-8 desktop-sm:grid desktop-sm:min-h-[calc(100vh-92px)] desktop-sm:grid-cols-[minmax(0,1fr)_454px] desktop-sm:items-center desktop-sm:gap-x-[62px] desktop-sm:py-16">
        ...
        <div className="flex min-h-[calc(100svh-92px)] flex-col justify-center gap-10 py-8 text-white desktop-sm:min-h-0 desktop-sm:justify-start desktop-sm:gap-[50px] desktop-sm:py-0">
          <div className="flex flex-col gap-8 desktop-sm:gap-[50px]">
            ...
            {(supportiveLead || supportiveText) && (
              <div className="flex items-stretch gap-5">
                ...
                <p className="text-[18px] leading-snug -tracking-[0.03em] text-navy-50 tablet:text-[28px] desktop-sm:text-[32px]">
        ...
        <div className="mx-[calc(50%-50vw)] bg-white pb-12 pt-10 desktop-sm:mx-0 desktop-sm:bg-transparent desktop-sm:pb-0 desktop-sm:pt-0">
          <div className="container desktop-sm:px-0!">
            <div className="mx-auto flex w-full max-w-[596px] flex-col gap-6 desktop-sm:max-w-none desktop-sm:rounded-[15px] desktop-sm:bg-white desktop-sm:px-8 desktop-sm:pb-[34px] desktop-sm:pt-[35px] desktop-sm:shadow-xl">
