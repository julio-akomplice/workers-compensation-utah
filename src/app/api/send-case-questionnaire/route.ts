...
const valueDisplayMap: Record<string, Record<string, string>> = {
  ...
  claimDenied: { yes: 'Yes', no: 'No' },
  hasPrivateMedicalInsurance: { yes: 'Yes', no: 'No' },
  whoPayedTreatment: {
  ...
  appliedForSocialSecurity: { yes: 'Yes', no: 'No' },
  priorBodyPartInjury: { yes: 'Yes', no: 'No' },
  priorInjuryLocation: { yes: 'Yes', no: 'No' },
  otherJobInjuries: { yes: 'Yes', no: 'No' },
  priorWcClaims: { yes: 'Yes', no: 'No' },
  offJobInjuries: { yes: 'Yes', no: 'No' },
  filedClaimOrLawsuit: { yes: 'Yes', no: 'No' },
  agreementAccepted: { true: 'Yes — Agreed', false: 'No' },
}
...
const labelMap: Record<string, string> = {
  ...
  wcInsuranceCompany: "Workers' Comp Insurance Company",
  wcInsurancePhone: "Workers' Comp Insurance Phone",
  claimsAdjusterName: 'Claims Adjuster Name',
  claimsAdjusterPhone: 'Claims Adjuster Phone',
  claimNumber: 'Claim Number',
  claimDenied: 'Claim Denied',
  hasPrivateMedicalInsurance: 'Has Private Medical Insurance',
  whoPayedTreatment: 'Who Paid for Treatment',
  unpaidMedicalBills: 'Unpaid Medical Bills',
  datesNotWorked: 'Dates Not Worked',
  wcBenefitsDates: "Workers' Comp Benefits Dates",
  appliedForSocialSecurity: 'Applied for Social Security Disability',
  otherBenefits: 'Other Benefits Received',
  priorBodyPartInjury: 'Prior Injury to Same Body Part',
  priorInjuryLocation: 'Prior Injury at Work',
  otherJobInjuries: 'Other On-the-Job Injuries',
  priorWcClaims: "Prior Workers' Comp Claims",
  offJobInjuries: 'Off-the-Job Injuries',
  priorInjuryDoctors: 'Doctors for Prior Injuries',
  filedClaimOrLawsuit: 'Filed Prior Claim or Lawsuit',
  otherMedicalConditions: 'Other Medical Conditions',
  otherConditionsDoctors: 'Doctors for Other Conditions',
